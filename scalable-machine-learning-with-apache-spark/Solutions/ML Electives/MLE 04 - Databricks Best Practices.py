...
# DBTITLE 0,--i18n-64f90be2-bcc0-40c9-bbe7-3b501323e71c
# MAGIC %md 
# MAGIC
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-0c063b0a-ccbb-486f-8568-1fe52cfa8971
# MAGIC %md 
# MAGIC
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC - **`Spill`**: Data is exhausting the cluster's memory and is spilling onto the disk. **Resolution:** a cluster with more memory resources
...
# MAGIC - **`Small/Large Files`**: Too many small files are exhausting cluster resources since each file read needs its own thread or a few large files are causing unused threads.  **Resolution:** rewrite data in a more optimized way or perform Delta file compaction
# MAGIC
...
# DBTITLE 0,--i18n-35f52f8a-6a95-4273-8e04-ead835c2c184
# MAGIC %md 
# MAGIC
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-2c6e2b76-709f-43e9-9fd2-731713fe30a7
# MAGIC %md 
# MAGIC
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-6368d08e-4f54-4504-8a83-5e099c7aeb34
# MAGIC %md 
# MAGIC
# MAGIC
# MAGIC
...
# MAGIC   
# MAGIC - <a href="https://docs.databricks.com/libraries/notebooks-python-libraries.html" target="_blank">Notebook-scoped Python libraries</a> ensure users on the same cluster can have different libraries.  Also good for saving notebooks with their library dependencies
# MAGIC - <a href="https://docs.databricks.com/clusters/init-scripts.html" target="_blank">Init scripts</a> ensure that code is run before the JVM starts (good for certain libraries or environment configuration)
# MAGIC - Some configuration variables need to be set on the cluster start

# COMMAND ----------

# DBTITLE 0,--i18n-dd0026c2-92e2-4761-9308-75ad353649d4
# MAGIC %md 
# MAGIC
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-ea44ac8c-88c8-443a-a370-b4671af6f1e9
# MAGIC %md 
# MAGIC
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-4bbc8017-a03b-4b3e-810f-9375e5afd7e2
# MAGIC %md 
# MAGIC
# MAGIC ## Databricks Admin Guide
# MAGIC
