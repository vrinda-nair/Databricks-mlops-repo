...
# DBTITLE 0,--i18n-ebdf53a8-2e92-41da-8b96-df365abf9d7c
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC
...
# MAGIC * Version:  **3.9.9**
# MAGIC * Built On: **Dec 1, 2023 at 11:19:59 UTC**
...
# MAGIC
# MAGIC This course is tested against and requires one of the following DBRs (Databricks Runtime): **12.2.x-cpu-ml-scala2.12**.
# MAGIC
